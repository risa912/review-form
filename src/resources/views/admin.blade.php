...
<div class="admin">
    ...
    <div class="admin__inner">
        <form class="search-form" action="/search" method="get">
            ...
            <din class="search-form__gender">
                <select class="search-form__gender-select" name="gender" value="{{('gender')}}">
        ...
        <table class="admin__table">
            ...
            <div class="modal" id="{{$contact->id}}">
                ...
                <div class="modal__inner">
                    ...
                    <!-- href="#!" は ダミーリンク（どこにも遷移しない）。
                    # だけだとページ先頭に飛んでしまうので、#! とすることで「無効リンク」にしてるだけ -->
                    <a href="#" class="modal__close-btn">×</a>
                    <!-- class="model-overlay" は、モーダルの背景をクリックしたら閉じる仕組み -->
                </div>
            </div>
            @endforeach
        </table>
